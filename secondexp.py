...
def start(bot, update):
    keyboard = [
        [InlineKeyboardButton(u"FISRT", callback_data=str(FIRST), url='https://www.youtube.com/watch?v=l3fpeT7UUHg')]
    ]
...
def first(bot, update):
    ...
    keyboard = [
        [InlineKeyboardButton(u"SECOND", callback_data=str(SECOND))]
    ]
    # reply_markup = InlineKeyboardMarkup(keyboard)
